...
const Header = () => (
  <header className="shadow-md pl-6 pr-6 pb-4 pt-4 bg-white flex w-screen justify-between items-center border-b-8  border-red-600">
    <img src="/img/logo.jpg" alt="Communisme Guerre Terrorisme" className="h-14" />
    <nav>
      <ul className="flex">
        <li>
        ...
        <li>
          <NavLink to="/services" className="linkItem">
            <svg
              xmlns="http://www.w3.org/2000/svg"
        ...
        <li className="flex">
          <NavLink to="/actualite" className="linkItem">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              className="h-6 w-6 mr-2"
              fill="none"
        ...
        <li>
          <NavLink to="/aboutus" className="linkItem">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              className="h-6 w-6 mr-4"
              fill="none"
